...
module OmniAuth
  module LDAP
    class Adaptor
      ...
      VALID_ADAPTER_CONFIGURATION_KEYS = [:host, :port, :method, :tls_options,
        :bind_dn, :password, :try_sasl, :sasl_mechanisms, :uid, :base,
        :allow_anonymous, :filter, :group_query, :group_attribute ]
      ...
      def initialize(configuration={})
        ...
        if method then
          ...
          config[:encryption] = {method: method, tls_options: @tls_options}
        end
